...
~~~
#### Gate level netlist
Synthesis has created a "gate level" netlist that has mapped the VHDL RTL code into a Verilog file, with logic mapped to PDK standard cells. These cells is being "instantiated" into the design.
~~~
